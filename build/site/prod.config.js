...
const { getDllVendor, join, isDev, entryHtml } = require('../config/utils');
    ...
    plugins: [
        ...
        */
        ...
        new CleanWebpackPlugin(
            {
                cleanOnceBeforeBuildPatterns: [join(process.cwd(), `./${ OptionsBuild.output.pathName || 'dist' }/*`)],
    	...
    	new PurifyCSSPlugin({
            ...
            paths: glob.sync(join(__dirname, '../../site/demo/app/*.html')),
        }),
